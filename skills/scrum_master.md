...
6. Planning完了後 → **#20-sprint に新スレッドを作成して**以下を投稿する：
   `@scrum-agent DEVモードで動いて。skills/developer.md と memory/dev/short_term.md と backlog/sprint_XX/sprint_backlog.md を読んで、作業を開始してください。`
...
4. Review完了後 → **#40-retrospective に新スレッドを作成して**以下を投稿する：
   `@scrum-agent SMモードで動いて。skills/scrum_master.md と memory/sm/short_term.md と memory/sm/long_term.md を読んで、レトロを実施してください。`
...
指示を受けたチャンネルで次のエージェントに指示するのではなく、必ず適切なチャンネルに移動する。
