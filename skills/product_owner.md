...
**バージョン**: 1.2.0
**最終更新**: 2026-04-20
**更新理由**: GitHub Projects連携・product_backlog.md廃止・Refinementフロー更新
...
1. GitHub MCPで `ryokkon624/hw-hub-manage` のIssue一覧を取得する
2. `Ready: Draft` のIssueを確認して、内容を充実させる提案をする
3. 以下を必ず確認する：
...
4. 充実したIssueは `Ready: Ready` または `Ready: NotReady` に更新する
